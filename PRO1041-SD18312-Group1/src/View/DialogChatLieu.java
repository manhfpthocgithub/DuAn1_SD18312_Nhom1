...
public class DialogChatLieu extends javax.swing.JDialog {
    ...
    private void fillTable() {
        ...
        for (ChatLieu cl : list) {
            tableModel.addRow(new Object[]{
                cl.getMaChatLieu(), cl.getTenChatLieu(), cl.isTrangThai() ? "Đang hoạt động" : "Ngừng hoạt động"
            });
        }
        tblChatLieu.setModel(tableModel);
    }
    ...
    private ChatLieu getModel() {
        return new ChatLieu(0, txtTenChatLieu.getText(), cboTrangThai.getSelectedIndex() == 0);
    }

    private boolean validateForm() {
        String tenChatLieu = txtTenChatLieu.getText().trim();
        if (tenChatLieu.equals("")) {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(cboTrangThai, 0, 145, Short.MAX_VALUE))
                .addGap(53, 53, 53)
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        if (validateForm()) {
            ...
            if (cldao.KiemTraTenChatLieu(txtTenChatLieu.getText())) {
                if (cldao.insert(getModel()) > 0) {
                ...
                JOptionPane.showMessageDialog(this, "Tên chất liệu đã tồn tại trong bảng .");
            }
        }
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        ...
        if (row > -1) {
            if (validateForm()) {
                ChatLieu chatLieu = getModel();
                chatLieu.setMaChatLieu(Integer.parseInt(txtMaChatLieu.getText().trim()));
                if (cldao.update(chatLieu) > 0) {
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        ...
        if (row > -1) {
            if (cldao.update(chatLieu) > 0) {
                ...
                JOptionPane.showMessageDialog(this, "Xóa chất liệu không thành công . ");
            }
        } else {
            JOptionPane.showMessageDialog(this, "Chưa dòng nào được chọn .");
        }
    ...
    private void tblChatLieuMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblChatLieuMouseClicked
        ...
        if (tblChatLieu.getValueAt(row, 2).toString() == "Đang hoạt động") {
            cboTrangThai.setSelectedIndex(0);
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogChatLieu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogChatLieu dialog = new DialogChatLieu(new javax.swing.JFrame(), true);
