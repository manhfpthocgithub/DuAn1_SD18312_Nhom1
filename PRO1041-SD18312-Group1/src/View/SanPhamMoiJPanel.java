...
//đường dẫn
    ...
    private void chonAnh() {
        JFileChooser jfc = new JFileChooser("C:\\PRO1041-SD18312-Group1\\logos\\");
    ...
    private void initComponents() {
        ...
        jPanel17Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel17Layout.createSequentialGroup()
                ...
                .addComponent(btnThemSP, javax.swing.GroupLayout.PREFERRED_SIZE, 86, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(btnChiTietSP1, javax.swing.GroupLayout.PREFERRED_SIZE, 147, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
        ...
        jPanel27.add(jPanel28, new org.netbeans.lib.awtextra.AbsoluteConstraints(11, 18, 110, 142));

        jPanel29.setLayout(new java.awt.GridLayout(4, 1, 0, 20));
        ...
        jPanel27.add(jPanel29, new org.netbeans.lib.awtextra.AbsoluteConstraints(127, 24, 140, 136));
        ...
        jPanel27.add(btnTimKiemSp3, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 170, -1, -1));
        ...
        jPanel8Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel8Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(txtTimTheoTen, javax.swing.GroupLayout.PREFERRED_SIZE, 162, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(jPanel27, javax.swing.GroupLayout.PREFERRED_SIZE, 287, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        jPanel12.add(btnThemMauSac, new org.netbeans.lib.awtextra.AbsoluteConstraints(219, 130, 40, 30));
        ...
        jPanel12.add(btnThemSize, new org.netbeans.lib.awtextra.AbsoluteConstraints(219, 90, 40, 30));
    ...
    private void btnTimTheoTenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTimTheoTenActionPerformed
        ...
        if (txtTimTheoTen.getText().trim().equals("")) {
            ...
            List<AoKhoacMuaDong> list = akmdDao.timKiemTheoTen(tenAo);
            for (AoKhoacMuaDong akmd : list) {
                ThuongHieuChiTiet thct = thctdao.selectById(akmd.getMaThuongHieuChiTiet());
                XuatXu xx = xxdao.selectById(thct.getMaXuatXu());
                ThuongHieu th = thdao.selectById(thct.getMaThuongHieu());
...
//đường dẫn
    private void tblSanPhamChiTiet2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblSanPhamChiTiet2MouseClicked
        ...
        System.out.println(tblSanPhamChiTiet2.getValueAt(row1, 0).toString().trim() + "a");
        if (tblSanPhamChiTiet2.getValueAt(row1, 0).toString().trim().equals("")) {
            ...
            ImageIcon icon = XImage.read(tblSanPhamChiTiet2.getValueAt(row1, 5).toString());
            int height = lblHinhAnh2.getHeight();
            int width = lblHinhAnh2.getWidth();
            File file = new File("C:\\PRO1041-SD18312-Group1\\logos\\" + tblSanPhamChiTiet2.getValueAt(row1, 5).toString());
