...
public class PhieuDoiJDiaLog extends javax.swing.JDialog {
    ...
    public PhieuDoiJDiaLog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//                this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PhieuDoiJDiaLog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PhieuDoiJDiaLog dialog = new PhieuDoiJDiaLog(new javax.swing.JFrame(), true);
