...
public class DotGiamGiaDAO extends DuAn1DAO<DotGiamGia,String> {
    ...
    public void update2(DotGiamGia entity) {
        JDBCHelper.executeUpdate(UPDATE_SQL,1,entity.getMaDotGiamGia());
    }
    ...
    @Override
    public int insert(DotGiamGia entity) {
    ...
    @Override
    public int update(DotGiamGia entity) {
