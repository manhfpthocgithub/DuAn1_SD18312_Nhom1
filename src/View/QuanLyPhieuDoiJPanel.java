...
//            List<PhieuDoi> list = pdd.selectAll();
    ...
    private void initComponents() {
        ...
        jPanel7Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel7Layout.createSequentialGroup()
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(btnInPDF, javax.swing.GroupLayout.PREFERRED_SIZE, 92, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel7Layout.setVerticalGroup(
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addComponent(btnInPDF, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(20, 20, 20))
        );
    ...
    private void btnInPDFActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInPDFActionPerformed
        // TODO add your handling code here:
        String Path = "D:\\FPT Polytechnic\\FALL 2023 (KI 4)\\BLOCK 2\\DU AN 1\\DuAn1_Nhom1";
        ...
        try {
            PdfWriter.getInstance(doc, new FileOutputStream(Path + "PhieuDoi.pdf"));
            
            doc.open();
            PdfPTable tbl = new PdfPTable(6);
            
            tbl.addCell("Mã Phiếu Đổi");
            tbl.addCell("Mã Hóa Đơn");
            tbl.addCell("Mã Khách Hàng");
            tbl.addCell("Ngày Đổi Hàng");
            tbl.addCell("Tiền Đã Thanh Toán");
            tbl.addCell("Lý Do");
            
            for (int i = 0; i < tblXemPhieuDoi.getRowCount(); i++) {
                
                String MaPD = tblXemPhieuDoi.getValueAt(i, 0).toString();
                String MaHD = tblXemPhieuDoi.getValueAt(i, 1).toString();
                String MaKH = tblXemPhieuDoi.getValueAt(i, 2).toString();
                String NgayDH = tblXemPhieuDoi.getValueAt(i, 3).toString();
                String TienTT = tblXemPhieuDoi.getValueAt(i, 4).toString();
                String LyDo = tblXemPhieuDoi.getValueAt(i, 5).toString();
            ...
            doc.add(tbl);
            MsgBox.alert(this, "IN PDF thành công !");
            
        } catch (FileNotFoundException ex) {
            Logger.getLogger(QuanLyPhieuDoiJPanel.class.getName()).log(Level.SEVERE, null, ex);
